 ...
 */
export declare function isComfyUIWorkflow(data: any): data is ComfyUIWorkflow;
/**
 * A1111パラメータかどうかを判定
 */
export declare function isA1111Parameters(data: any): data is A1111Parameters;
/**
 * 抽出データが有効かどうかを判定
 */
export declare function isValidExtractedData(data: any): data is ExtractedData;
